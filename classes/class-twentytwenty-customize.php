	...
	class TwentyTwenty_Customize {
		...
		public static function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                'layout',
                array(
                    'title'    => __( 'Layout', 'twentyseventeen' ),
            ...
            $wp_customize->add_control(
                ...
                array(
                    ...
                    'section'  => 'layout',
                    'priority' => 10,
                    'label'    => __( 'Layout width', 'twentytwenty' ),
                    'choices'  => array(
                        'full'    => __( 'Full', 'twentytwenty' ),
                        'narrow' => __( 'Narrow', 'twentytwenty' ),
                    ),
                )
            );
            ...
            $wp_customize->add_control(
                ...
                array(
                    ...
                    'section'  => 'layout',
                    'priority' => 20,
                    'label'    => __( 'Navigation position', 'twentytwenty' ),
                    'choices'  => array(
                        'center'    => __( 'Center', 'twentytwenty' ),
                        'left' => __( 'Left', 'twentytwenty' ),
                    ),
                )
            );
		}
